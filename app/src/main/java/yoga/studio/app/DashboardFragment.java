 ...
 */
public class DashboardFragment extends Fragment implements DashboardAdapter.Listener{
...
//        arrayList = dbHelper.getAllCategories();
    ...
    public void onClick(Categories categories) {
        ...
        for(Items items : AppData.init_data(getContext())){
            if (items.idcategories == categories.idCategories){
                Utilities.getInstanceFromCate().add(items);
            }
        }
